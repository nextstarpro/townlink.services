...
export function SuccessState({ isReturning }: { isReturning?: boolean }) {
  ...
  return (
    <div className="p-8 md:p-12 text-center animate-in fade-in zoom-in-95 duration-500">
      ...
      <button 
        ...
        className="inline-flex items-center justify-center gap-2 bg-[#25d366] hover:bg-[#1fb855] text-white font-semibold py-3.5 px-6 rounded-lg transition-colors text-sm w-full md:w-auto shadow-sm"
      >
      ...
      <div className="mt-8 pt-6 border-t border-border-light text-sm font-medium">
        <a href="/" className="text-text-muted hover:text-brand-primary transition-colors">Return to Home</a>
      </div>
    </div>
  );
}
