        ...
        <div className="max-w-7xl mx-auto px-6 h-full flex items-center justify-between">
          ...
          <div className="flex items-center gap-4 shrink-0">
             ...
             <a href="/register-provider">
               <AppButton variant="secondary" className="hidden sm:inline-flex">Become a Provider</AppButton>
             </a>
          </div>
        </div>
      </div>
        ...
        <div className="px-6 py-4 flex flex-col gap-4">
          ...
          <div className="flex flex-col gap-3 pb-2">
             <a href="/register-provider" className="w-full" onClick={() => setIsMobileMenuOpen(false)}>
               <AppButton variant="secondary" className="w-full">Become a Provider</AppButton>
             </a>
